...
public class ClientEjbliteservlet2Test extends Client {
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_xa_ejbliteservlet2_vehicle";
        ...
        // War
            ...
            WebArchive ejb32_lite_timer_basic_xa_ejbliteservlet2_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejb32_lite_timer_basic_xa_ejbliteservlet2_vehicle_web.war");
            // The class files
            ejb32_lite_timer_basic_xa_ejbliteservlet2_vehicle_web.addClasses(
            ...
            Client.class,
            com.sun.ts.tests.ejb32.lite.timer.basic.xa.EJBLiteServlet2Filter.class,
            ...
            if(warResURL != null) {
              ejb32_lite_timer_basic_xa_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
        ...
        return ejb32_lite_timer_basic_xa_ejbliteservlet2_vehicle_web;
        }
