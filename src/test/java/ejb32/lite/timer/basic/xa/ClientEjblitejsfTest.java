...
public class ClientEjblitejsfTest extends Client {
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_xa_ejblitejsf_vehicle";
        ...
        // War
            ...
            URL warResURL = Client.class.getResource("/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejb32_lite_timer_basic_xa_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/vehicle/ejblitejsf/ejblitejsf_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
