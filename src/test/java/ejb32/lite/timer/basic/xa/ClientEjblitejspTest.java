...
import com.sun.ts.tests.ejb32.lite.timer.basic.xa.Client;
...
public class ClientEjblitejspTest extends Client {
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_xa_ejblitejsp_vehicle";
        ...
        // War
            ...
            WebArchive ejb32_lite_timer_basic_xa_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejb32_lite_timer_basic_xa_ejblitejsp_vehicle_web.war");
            // The class files
            ejb32_lite_timer_basic_xa_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb32.lite.timer.basic.xa.EJBLiteJSPTag.class,
            ...
            if(warResURL != null) {
              ejb32_lite_timer_basic_xa_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejb32_lite_timer_basic_xa_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
        ...
        return ejb32_lite_timer_basic_xa_ejblitejsp_vehicle_web;
        }
